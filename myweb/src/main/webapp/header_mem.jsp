...
<div class="container">
    ...
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
   	...
   	<div>
	  	<a href="<%=request.getContextPath()%>/index.jsp">
	  		<img class="img-responsive" alt="ozlogo" src="../images/miniproj/logo.png" width="120px;" style="display:inline;">
	  	</a>
	</div>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li><a class="font2" href="./loginForm.jsp"><span class="glyphicon glyphicon-log-in"></span> 로그인</a></li>
    </ul>
    </div>
</div>
</nav> <!-- 메인 카테고리 끝 -->
