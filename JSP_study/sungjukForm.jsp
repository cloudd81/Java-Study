...
<body>
	...
	<div class="container">
		...
		<form name="sungjukfrm" id="sungjukfrm" method="post" action="sungjukIns.jsp">
			...
			<tr>
			  <th>국어 : </th>
			  <td><input type="number" name="kor" size="5" min="0" max="100" required autofocus placeholder="숫자입력"></td>
			</tr>
			<tr>
			  <th>영어 : </th>
			  <td><input type="number" name="eng" size="5" min="0" max="100" required autofocus placeholder="숫자입력"></td>
			</tr> 
			<tr>
			  <th>수학 : </th>
			  <td><input type="number" name="mat" size="5" min="0" max="100" required autofocus placeholder="숫자입력"></td>
			</tr>
			<tr>
			  <th>주소 : </th>
			  <td>
